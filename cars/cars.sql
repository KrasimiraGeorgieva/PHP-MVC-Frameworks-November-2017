...
-- Dumping database structure for carsdb
DROP DATABASE IF EXISTS `carsdb`;
CREATE DATABASE IF NOT EXISTS `carsdb` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `carsdb`;

-- Дъмп структура за таблица carsdb.cars
...
-- Дъмп данни за таблица carsdb.cars: ~358 rows (approximately)
...
-- Дъмп структура за таблица carsdb.customers
DROP TABLE IF EXISTS `customers`;
CREATE TABLE IF NOT EXISTS `customers` (
  `id` bigint(20) NOT NULL,
  `name` varchar(255) NOT NULL,
  `birthDate` datetime NOT NULL,
  `isYoungDriver` bit(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Дъмп данни за таблица carsdb.customers: ~30 rows (approximately)
...
-- Дъмп структура за таблица carsdb.parts
...
-- Дъмп данни за таблица carsdb.parts: ~131 rows (approximately)
...
-- Дъмп структура за таблица carsdb.parts_cars
...
-- Дъмп данни за таблица carsdb.parts_cars: ~1� 170 rows (approximately)
...
-- Дъмп структура за таблица carsdb.sales
...
-- Дъмп данни за таблица carsdb.sales: ~50 rows (approximately)
...
-- Дъмп структура за таблица carsdb.suppliers
DROP TABLE IF EXISTS `suppliers`;
CREATE TABLE IF NOT EXISTS `suppliers` (
  `id` bigint(20) NOT NULL,
  `name` varchar(255) NOT NULL,
  `isImporter` bit(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Дъмп данни за таблица carsdb.suppliers: ~31 rows (approximately)
